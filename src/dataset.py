...
class DataLoader():
    ...
    def __init__(self, batch_size=50, seq_length=5, alpha=50,
                 datasets_dir=['./data/eth/univ', './data/ucy/zara/zara01'], 
    ...
    def next_batch(self):
        ...
        for i in range(self.batch_size):
            ...
            n_batch = int(self.alpha * traj.shape[0] / (self.seq_length+2)) # one ped's traj contains n_batch segments which are longer than seq_len+2
            ...
            if random.random() < (0.01/float(n_batch)):
